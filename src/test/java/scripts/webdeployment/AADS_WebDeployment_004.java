...
public class AADS_WebDeployment_004 {
	...
	final static Logger logger = LogManager.getLogger("AADS_WebDeployment_004");

	@Before
	public void beforetestAADS_WebDeployment_001() throws Exception {
		logger.info("beforetest AADS_WebDeployment_004 starting...\n");
		webDriver = driverMgnt.createChromeDriver();

		windowsDriverRoot = driverMgnt.createWinAppDriver("http://10.255.249.9:4724");
		//winClient.confirmOpenApp(winClientDriver);
		logger.info("beforetest AADS_WebDeployment_004 completed...\n");
	}
	

	@Test 
	public void AADS_WebDeployment_004 () throws Exception {
		logger.info("AADS_WebDeployment_004 - starting...\n");
		try {
			...
			logger.info("AADS_WebDeployment_004 - Passed\n");
			
		} catch (Exception exception) {
			logger.error("AADS_WebDeployment_004 - Failed with Exception:" + exception
					+ "...\n");
			fail("AADS_WebDeployment_004 - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("AADS_WebDeployment_004 - completed...\n");
	}
