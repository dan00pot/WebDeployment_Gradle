...
public class AADS_WebDeployment_001 {
	...
	@Before
	public void beforetestAADS_WebDeployment_001() throws Exception {
		logger.info("beforetest AADS_WebDeployment_001 starting...\n");
	//	webDriver = driverMgnt.createChromeDriver();
	//	winClientDriver = driverMgnt.createWindowsClientDriver("http://10.255.249.9:9999");
		windowsDriverRoot = driverMgnt.createWinAppDriver("http://10.255.249.9:4724");
	//	winClient.confirmOpenApp(windowsDriverRoot);
		logger.info("beforetest AADS_WebDeployment_001 completed...\n");
	}
	

	@Test 
	public void AADS_WebDeployment_001 () throws Exception {
		logger.info("AADS_WebDeployment_001 - starting...\n");
		try {
			...
			Thread.sleep(18000);
			winClient.autoConfigLogin(windowsDriverRoot, "https://aads.aam1.com:443/acs/resources/configurations", "kwagner@aam1.com", "tma_12Tma");
			...
			winClient.verifyEquinoxUpdateAvailable(windowsDriverRoot,"3.5.5.90.17" , "3.5.7.9");
			winClient.uninstallEquinoxforWindows(windowsDriverRoot);
			logger.info("AADS_WebDeployment_001 - Passed\n");
			assertTrue(true);
		} catch (Exception exception) {
			logger.error("AADS_WebDeployment_001 - Failed with Exception:" + exception
					+ "...\n");
			fail("AADS_WebDeployment_001 - Failed - Exception occurs: "
					+ exception.toString());
			assertTrue(false);
		}
		logger.info("AADS_WebDeployment_001 - completed...\n");
	}
